...
public class BlockBreakerScreen extends ItemEnergyScreen<BlockBreakerContainer> {

	private ResourceLocation GUI = MiningUtilsResources.BLOCK_BREAKER_GUI;
	private ResourceLocation OVERLAY = MiningUtilsResources.OFFSET;
	
	public BlockBreakerScreen(BlockBreakerContainer pMenu, Inventory pPlayerInventory, Component pTitle) {
