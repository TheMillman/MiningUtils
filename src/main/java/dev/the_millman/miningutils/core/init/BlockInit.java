...
import dev.the_millman.miningutils.common.blocks.BucketBlock;
import dev.the_millman.miningutils.common.blocks.HogPanBlock;
import dev.the_millman.miningutils.common.blocks.VerticalMinerBlock;
import dev.the_millman.miningutils.common.blocks.WaveTableBlock;
...
public class BlockInit {
	...
	public static final RegistryObject<Block> BUCKET_BLOCK = BLOCKS.register("bucket_block", () -> new BucketBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.5F).sound(SoundType.BAMBOO)));
